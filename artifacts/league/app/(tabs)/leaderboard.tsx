...
const styles = StyleSheet.create({
  ...
  myPositionLabel: { fontSize: 10, fontWeight: "800", letterSpacing: 1 },
  myPositionRow: { flexDirection: "row", alignItems: "baseline", gap: 10, marginTop: 4 },
  myPositionNum: { fontSize: 28, fontWeight: "800" },
  myPositionRating: { fontSize: 13, fontWeight: "500" },
  ...
  rowUsername: { fontSize: 14, fontWeight: "700" },
  ...
  meBadgeText: { fontSize: 9, fontWeight: "800", letterSpacing: 0.5 },
  rowStats: { alignItems: "flex-end", gap: 2 },
  rowRating: { fontSize: 18, fontWeight: "800" },
  rowStatLabel: { fontSize: 8, fontWeight: "700", letterSpacing: 0.5 },
  rowAvg: { fontSize: 11, fontWeight: "500" },
});
