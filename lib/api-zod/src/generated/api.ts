...
export const GetMeResponse = zod.object({
  ...
  team: zod.string(),
  bsr: zod.number().optional().default(1200),
  wins: zod.number().optional().default(0),
  losses: zod.number().optional().default(0),
  revRate: zod.number().nullish(),
  ballSpeed: zod.number().nullish(),
  axisTilt: zod.number().nullish(),
  axisRotation: zod.number().nullish(),
  papOver: zod.string().nullish(),
  papUp: zod.string().nullish(),
  releaseStyle: zod.string().nullish(),
  gripStyle: zod.string().nullish(),
  dominantHand: zod.string().nullish(),
