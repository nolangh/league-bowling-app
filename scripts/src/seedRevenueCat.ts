...
const PROJECT_NAME = "League";

const PRODUCT_IDENTIFIER = "league_pro_monthly";
const PLAY_STORE_PRODUCT_IDENTIFIER = "league_pro_monthly:monthly";

const PRODUCT_DISPLAY_NAME = "League Pro Monthly";
const PRODUCT_USER_FACING_TITLE = "League Pro";
const PRODUCT_DURATION = "P1M";

const APP_STORE_APP_NAME = "League iOS";
const APP_STORE_BUNDLE_ID = "com.league.bowlingapp.ios";
const PLAY_STORE_APP_NAME = "League Android";
const PLAY_STORE_PACKAGE_NAME = "com.league.bowlingapp.android";
